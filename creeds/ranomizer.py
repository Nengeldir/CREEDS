...
def randomizeCluster(directory: str, cluster_file : str, output_dir: str, randomizeCluster : str = "Cluster_4.sdf", numLigands : int = 15):
...
if __name__ == '__main__':
    randomizeCluster('clusters.json', 'output/')